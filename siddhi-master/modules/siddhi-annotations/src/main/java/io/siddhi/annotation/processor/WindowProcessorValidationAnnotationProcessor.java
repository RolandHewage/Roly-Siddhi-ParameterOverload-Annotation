...
//            if(parameterOverload.parameterNames().length == 1){
//
//            } else {
//                throw new AnnotationValidationException(MessageFormat.format("The @Extension -> @ParameterOverload -> " +
//                                "parameterNames annotated in class {0} should only have one parameter",
//                        extensionClassFullName));
//            }
